...
<!------ Include the above in your HEAD tag ---------->
   ...
   <?php include 'includes/navbar.php';?>
    ...
    <div class="container container mt-4 mb-9" style="margin-top: 25px;">
        ...
        <h1 style="font-size:50px;">WATCH: Top funny videos you want to watch on Youtube</h1>
        <h1 style="font-size:16px;">Posted on April 12, 2020</h1>
        ...
        <p class="text-danger"><b>Warning:</b> This video has a disgusting stuff!</p>
        <figure>
        ...
        <p>The song "Let It Go" was the chart success.</p>

        <h5>3. Jhepoy Dizon remixes</h5>
        <figure>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/bggjWLXf9LQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </figure>
        <p>After the boy cursing Jhepoy Dizon on webcam few years later, uploader Zerona made a remix version of a Nestle's Milo music video with the boy's face applied over actor and singer James Reid's face.</p>

        <figure>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/s8jdideSSwg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </figure>
        <p>Another video of Martin Garrix's Animals, also with the boy's face applied to Garrix's face.</p>
            ...
            <div class="container">
                <div class="row py-4">
                    <div class="col-md-6 col-lg-7">
                        <h4 class="mb-0 white-text">Get connected with me on social networks!</h4>
                    </div>
                    <div class="col-md-6 col-lg-5 text-right">
                        
                        <a><img src="img/facebook.png" width="16px;" height="16px;" alt="Italian Trulli"> </a>
                        <a><img src="img/instagram.png" width="16px;" height="16px;" alt="Italian Trulli"> </a>
                        <a><img src="img/174876.svg" width="16px;" height="16px;" alt="Italian Trulli"></a>
                    </div>
                </div>
            </div>
        </div>
