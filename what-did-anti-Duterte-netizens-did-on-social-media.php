...
<!------ Include the above in your HEAD tag ---------->
   ...
   <?php include 'includes/navbar.php';?>
    ...
    <div class="container container mt-4 mb-9" style="margin-top: 25px;">
        ...
        <h1 style="font-size:50px;">What did anti-Duterte netizens did on social media?</h1>
       ...
       <p>Anti-Duterte netizens usually uses pro-Duterte signature words such as "DDS Trolls", “ka-DDS”, “Tatay niyo”, "Pduts", "16M" (refers to the 16 million people who voted Duterte), etc. as a mockery against the pro-Duterte netizens in times of various situations occurred in the country.</p> Other words include "Dutae", "Dudirty", "Dutete", "Dutertard(s)" etc, was used by ordinary people during Duterte's 2016 presidential campaign and his subsequent early administration. However, since 2018, these words are now used rarely.</p>

       <h5>Blaming Duterte for failure on elections</h5>
        <p>Logically, when the opposition candidates loses, many supporters believe that they have been cheated; but when the opposition candidate wins, the majority of the supporters believe that the election is running fair. The former causes the people to trigger a protest. Our voting system uses the automated counting machine, however, theory arose that these machine can be cheated. Regardless the COMELEC showing the transparency of the voting results, it could be, what was alleged by anti-Duterte figures, cheated.</p>
